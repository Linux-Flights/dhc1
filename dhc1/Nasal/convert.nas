...
var convert = func {
  ...
  setprop("/engines/engine[0]/oiltC", convertTemp(getprop("/engines/engine[0]/oil-temperature-degf")));
  setprop("/engines/engine[1]/oiltC", convertTemp(getprop("/engines/engine[1]/oil-temperature-degf")));
  setprop("/engines/engine[2]/oiltC", convertTemp(getprop("/engines/engine[2]/oil-temperature-degf")));
  setprop("/engines/engine[3]/oiltC", convertTemp(getprop("/engines/engine[3]/oil-temperature-degf")));
  setprop("/engines/engine[4]/oiltC", convertTemp(getprop("/engines/engine[4]/oil-temperature-degf")));
  setprop("/engines/engine[5]/oiltC", convertTemp(getprop("/engines/engine[5]/oil-temperature-degf")));
}
